...
![OpenSpare project template](/img/contributing_pcb_project_template.png)
...
![Schematics preview](/img/contributing_pcb_schematics_preview.png)

- PCB:

![PCB preview](/img/contributing_pcb_pcb_preview.png)
